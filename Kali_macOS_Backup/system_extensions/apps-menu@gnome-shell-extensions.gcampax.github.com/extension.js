...
class ApplicationsButton extends PanelMenu.Button {
    ...
    scrollToCatButton(button) {
        const catsScrollBoxAdj = this.categoriesBox.actor.get_vadjustment();
        const catsScrollBoxAlloc = this.categoriesBox.actor.get_allocation_box();
...
*/
        ...
        this.leftBox.actor.add_child(this.categoriesBox.actor);
        this.mainBox.addMenuItem(this.leftBox);
        this.mainBox.actor.add_child(this.applicationsScrollBox);
